...
public:
     ...
     //funkcja do pobierania danych od klienta
      ...
      //Funkcja pokazuje szczegoly klienta
...
//klasa klienta konczy sie tutaj
//Funkcja do modyfikacji danych klienta
...
//Funkcja dodawania zamówien w pliku
void write_customer()
{
      ofstream objoff;
      customer cobj;
...
//Funkcja sprawdzajaca numer klienta czy jest juz podany lub nie
int getcustomers()
{
      ifstream objiff;
      customer cust;
      ...
      //***********przeniesione zostalo do ostatniej linni
...
//Funkcja do odczytu okreslonego zamowienia z pliku
...
// Funkcja sluzy do wyswietlania wszystkich klientow
void cust_tabular()
{
      int r=0,col=10;
      customer cust;
...
//funkcja wyswietlajaca naglowek szczegolow klienta
void customer_detail_heading()
{
      cout<<"                                                                         "<<endl;
      cout<<"                    C U S T O M E R  D E T A I L S                       "<<endl;
      cout<<"                                                                         "<<endl;
      cout<<"CUST.NO"<<setw(13)<<"NAME"<<setw(23)<<"ADDRESS"<<setw(27)<<"PHONE NO"<<endl;
      cout<<"                                                                         "<<endl;
}
//Funkcja do modyfikowania zamowien klienta
void modify_cust_record(int n)
{
      ...
      {
      //modyfikowanie zamowien rozpoczyna sie tutaj
            fstream File;
...
//Funkcja sluzaca do usuwania wpisu klienta
...
void write_customer1()
{
      ...
      if(r>100)
      {
       ...
       objoff.write((char*)&cobj,sizeof(customer));
       objoff.close();
       cout<<"         C U S T O M E R   R E C O R D  S A V E D        "<<endl;
       cin.ignore();
       cin.get();
       cust_menu3();
}
...
//Klasa produktu zaczyna sie tutaj:
class product
{
      int prodid;
      char name[50];
      ...
      //Funkcja wyswietla dane produktu
      void showall(int c)
      {
...
// Klasa produktu konczy sie tutaj
// Funkcja modyfikujaca szczegoly produktu
...
fstream fp;
product pr;
// Funkcja zapisu szczegow produktu w pliku
void write_book()
{
      ...
      fp.close();
      cout<<"             P R O D U C T S  R E C O R D  S A V E D         "<<endl;
      cin.ignore();
      cin.get();
}
//Funkcja pozwalajaca sprawdzic numer produktu
int getproduct()
{
      ifstream objiff;
      product st;
...
//Funkcja odczytu okreslonego zamowienia z pliku
...
//Funkcja umozliwiajaca zlozenie zamowienia i wygenerowanie faktury za zakupiony produkt
void place_order()
{
      order o1[50];
      int c=0,pr1=0;
...
// FUNKCJA WYŒWIETLANIA WSZYSTKICH PRODUKTOW W FORMIE TABELARYCZNEJ
void prod_tabular()
{
      int r=0,col=10;
      product st;
...
//Funkcja wyswietlania naglowka oraz szczegolów produktu
void product_detail_heading()
{
      cout<<"                                                                         "<<endl;
      cout<<"                     P R O D U C T S  D E T A I L S                      "<<endl;
      cout<<"                                                                         "<<endl;
      cout<<"PROD.NO"<<setw(10)<<"NAME"<<setw(13)<<"COMPANY"<<setw(12)<<"PRICE"<<setw(13)<<"QUANTITY"<<setw(15)<<"DISCOUNT"<<endl;
      cout<<"                                                                         "<<endl;
}
//Funkcja do modyfikacji zapisu
void modify_record(int n)
{
      product st,temp;
...
//Funkcja do usuwania produktow z zamowienia
void delete_record(int n)
{
      product st;
      ifstream inFile;
...
//Funkcja zmiany ilosci produktu
void changeqty(int pr1,int q11)
{
      product st;
      int fpos=-1;
...
//Funkcja kopiowania wszystkich zapisów do struktury
...
void intro()
{
      ...
      cout<<"                                                                         "<<endl;
      cout<<"                                                                         "<<endl;
      cout<<"                    PRESS ENTER IF WANT START PROGRAM                    "<<endl;
      cout<<"                                                      &produced_by_Bartek"<<endl;
      cin.get();
}
// Menu kilenta
void customer_menu()
{
      char ch2;
      int num;
      cout<<"\n                 C U S T O M E R S   M E N U                           "<<endl;
      cout<<"                                                      &produced_by_Bartek"<<endl;
...
// Funkcja sluzaca do wyswietlania opcji klienta podczas skladania zamowienia
void cust_menu1()
{
      char ch2;
      int num;
...
// Funkcja sluzaca do wyswietlania opcji klienta podczas zamowienia
void cust_menu3()
{
      char ch2;
      int num;
...
void mainMenu(){
     char ch;
      do
      {
            cout<<endl;
            cout<<"                                                                         "<<endl;
            cout<<"                  R E S T A U R A N T   S Y S T E M                      "<<endl;
            cout<<"                                                                         "<<endl;
...
int Login()
{
    ...
    cout<<endl;
    cout<<"                                                                         "<<endl;
    cout<<"                        RESTAURANT S Y S T E M                           "<<endl;
    cout<<"                                                                         "<<endl;
    cout<<"                                                      &produced_by_Bartek"<<endl;
    cout<<endl;
